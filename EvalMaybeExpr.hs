...
evalMaybeExpr (Id x) list = lookup x list
evalMaybeExpr (Leaf num) _ = Just num
evalMaybeExpr (Add e1 e2) assoc = do
    value1 <- evalMaybeExpr e1 assoc
    value2 <- evalMaybeExpr e2 assoc
