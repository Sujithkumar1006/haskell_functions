...
evalIdExpr (Id x) list = case lookup x list of
        Just value -> value
        Nothing    -> 0
evalIdExpr (Leaf num) _ = num
evalIdExpr (Add e1 e2) list = evalIdExpr e1 list + evalIdExpr e2 list
evalIdExpr (Mul e1 e2) list = evalIdExpr e1 list * evalIdExpr e2 list
evalIdExpr (Sub e1 e2) list = evalIdExpr e1 list - evalIdExpr e2 list
evalIdExpr (Uminus e1) list =  - evalIdExpr e1 list
